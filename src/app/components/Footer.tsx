  ...
  return (
    <>
        ...
        <div className="flex flex raw justify-around p-8">
          <div>
            <ul className="flex flex-col gap-3">
              <Link href={"#sectionSucre"}>
                {" "}
                <li> Sucrés</li>
              </Link>
              <Link href={"#sectionSale"}>
                {" "}
                <li>Salés</li>
              </Link>
              <Link href={"#sectionSale"}>
          ...
          <div>
            <ul className="flex flex-col gap-3">
              <Link href={"#traditionnel"}>
                {" "}
                <li>Traditionnels</li>
              </Link>
              <Link href={"/"}>
                {" "}
                <li>Gâtaux oriental</li>
              </Link>
      ...
      <section className="bg-zinc-300  pt-4 items-center">
            ...
            <div className="flex flex-raw gap-2  ">
              <Link href={"/"}>
                <FontAwesomeIcon
                  ...
                  className=" w-7 text-black z-50"
                />
              </Link>
              <Link href={"/"}>
                <FontAwesomeIcon
                  icon={faYoutube}
                  className=" w-10 text-black z-50"
                />
              </Link>
              <Link href={"/"}>
                <FontAwesomeIcon
        ...
        <p className="text-l flex justify-center p-7">
          © Tous droits réservés - 2024 Raouf CHERIF
        </p>
      </section>
    </>
  );
