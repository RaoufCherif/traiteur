...
<>
         ...
         <h4 className="  font-serif hover:font-sans  text-rose-400 text-lg" key={index}>{item.name}</h4>
        ...
        <div className=" mt-10 flex flex-col  items-center">
          <h2  className=" font-serif hover:font-sans  text-rose-400 text-4xl ">35€ pour 40 pièces</h2>
          <h6 className="mb-20  font-serif hover:font-sans text-rose-400 ">8 pièces de chaque types</h6>
          <button className="rounded  bg-gradient-to-b from-pink-100 to-green-400 p-4 mb-10">Commander</button>
        </div>
        </section>
  )
}
